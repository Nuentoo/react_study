...
const Thread: React.FC<ThreadProps> = ({ posts }) => {
      ...
      >
        ...
        <div className="flex gap-3 text-sm text-gray-600">
          ...
          <p className="leading-relaxed">
            ...
            Expect answer to be less accurateI could not find the answer to this
          ...
          <div key={post.id} className="flex gap-3 text-sm text-gray-600">
            ...
            <p className="whitespace-pre-wrap leading-relaxed">
              <span className="block">
                ...
                <small className="text-gray-400">{post.create_at}</small>
              </span>
              {post.message}
            </p>
          </div>
